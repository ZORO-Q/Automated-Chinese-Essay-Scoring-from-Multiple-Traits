...
class Model(nn.Module):
    ...
    def forward(self,idx,idx1):#batch*max_para*max_sent*emb_dim idx1:batch*20,idx2:1.idx3:1,idx4:1
        ...
        print(batch,max_para,max_sent,emb_dim)
        res = []
        ...
        # out3 = self.fcs_3(out)
        # out4 = self.fcs_4(out)
        # idx1 = idx1.unsqueeze(dim=0)
        # idx1 = self.fc_t(idx1)
        # print(idx1.shape,output.shape)
